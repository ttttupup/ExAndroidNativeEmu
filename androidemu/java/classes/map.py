...
class HashMap(metaclass=JavaClassDef, jvm_name='java/util/HashMap'):
    ...
    @java_method_def(name='get', args_list=["jobject"], signature='(Ljava/lang/Object;)Ljava/lang/Object;',
                     native=False)
    ...
    @java_method_def(name='put', args_list=["jobject", "jobject"],
                     signature='(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;', native=False)
...
class Map(metaclass=JavaClassDef, jvm_name='java/util/Map'):
    def __init__(self, pydict={}):
        self.__pydict = pydict
